...
- **ai-proxy-server** — 后端，基于 NestJS，代理转发 AI API 请求（OpenAI / DeepSeek / Codex / Gemini）
...
antdXStudy (Umi, :8000)
  ...
  │                 │
  │                 └─→ OpenAI / DeepSeek / Codex / Gemini API
  │
...
- **[src/ai-proxy/](ai-proxy-server/src/ai-proxy/)** — 核心代理模块
  ...
  - `ai-proxy.service.ts` — 平台配置映射 + 代理请求逻辑，支持 OpenAI / DeepSeek / Codex / Gemini / custom
